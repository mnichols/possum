        ...
        .enclose(function(){
            ...
            var handlerDeferral = stampit()
                ...
                .enclose(function(){
                    ...
                    this.specifications.push(function(msg) {
                        if(passes && transitionHandler(msg)) {
                            return msg.inputType === '_onEnter'
                        }
            ...
            var defaultQueue = stampit()
                ...
                .methods({
                    ...
                    ,appendDeferred: function(msgs){
                        var sats = []
                        while(!!msgs.length) {
                            var msg = shift.call(msgs)
                            this.deferrals.forEach(function(def, index){
                                if(def.isSatisfiedBy(msg)) {
                                    def.appendTo(this.buffer)
                                    sats.push(index)
                                }
                            }, this)
                            //clean up
