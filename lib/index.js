...
module.exports = function possum(cfg) {
        ...
        .enclose(function(){
            ...
            stampit.mixIn(this, {
                current: function(context) {
                    if(!context) {
                        return (currentContext = primaryQueue.createContext(this))
                    }
    ...
    var deferrable = stampit()
        .enclose(function(){
            ...
            if(!this.queue) {
                throw new Error('a primary queue has not been assigned')
            }
            ...
            //add these queues as nested queues
            this.queue.addQueue(transitionDeferralQueue)
            this.queue.addQueue(handlerDeferralQueue)
